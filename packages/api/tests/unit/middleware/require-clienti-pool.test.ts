...
import { requireClientiPool } from '../../../src/middleware/require-clienti-pool.js';
...
describe('requireClientiPool middleware', () => {
  ...
  it('passes through when authPool === clienti', async () => {
