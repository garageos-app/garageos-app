...
<p>L'officina <strong>${escapeHtml(input.tenant.nameLegal)}</strong> ha modificato un intervento sul tuo veicolo.</p>
${reasonBlock}
...
L'officina ${input.tenant.nameLegal} ha modificato un intervento sul tuo veicolo.
${reasonBlock}
